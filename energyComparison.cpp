...
void energyComparison()
{
    ...
    for (auto &input : inputFiles)
    {
        ...
        std::cout << "done at least once" << std::endl;
        if (!energyDeposition.back()) std::cout << "energyDeposition is null" << std::endl << std::endl;
    }
...
///////////////modified energy////////////////////////
    ...
    // energyDeposition[1]->SetTitle(histsTitles[0]+" "+energyTitles[j]+" GeV");
